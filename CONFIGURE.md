...
| `lines` | List | This limits what is displayed to specific train lines (e.g., `['OR', 'SV',]`) for a given station. If left empty ([]), there will not be any filtering of results by line; you'll get everything. In many cases, this will be the desired behavior. |
