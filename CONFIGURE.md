...
| `lines` | List | This limits what is displayed to specific train lines (e.g., `['OR', 'SV',]`) for a given station. If left empty ([]), there will not be any filtered of results by line. |
