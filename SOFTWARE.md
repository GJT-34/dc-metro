...
4. Download the files in this repository (i.e., wmata_metro_info_board) as a ZIP file by selecting the green _Code_ button at the top of this repository's [home page](https://github.com/GJT-34/wmata_metro_info_board), selecting the _Local_ tab, and selecting the _Download ZIP_ link.
