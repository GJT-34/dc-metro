...
4. Download the files in this repository (i.e., [wmata_metro_trainboard](https://github.com/GJT-34/wmata_metro_trainboard)) as a ZIP file by selecting the green 'Code' button at the top of this page, selecting the "Local" tab, and selecting the "Download ZIP" link.
...
7. Going back to the recently-created folder on your compueter will be a folder will be a folder called _src_, and in that folder will be a file called _settings.toml_ that you need to edit. Open this file, fill in your wifi SSID, wifi password, and WMATA API key, and save the file.

8. Copy all of the files from the _src_ folder into the root of the _CIRCUITPY_ volume. The final file structure should look like this:
