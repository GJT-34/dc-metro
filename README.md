...
I became one of several people who decided to set up forks on github of the original project, which has not been updated since 2020. At the time, my main contribution was to edit the default font to more closely resemble the font on Metro's train boards. This was a little tricky not only because of the space considerations of the 64x32 screen, but because Metro's train boards use multiple fonts with subtle differences. You can see some examples in these train board pics:
